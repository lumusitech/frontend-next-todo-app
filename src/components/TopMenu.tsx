...
const getTotalCount = (cart: Cart) => {
  return Object.values(cart).reduce((acc: number, val: number) => acc + val, 0)
}
      ...
      <div className='sticky z-10 top-0 h-16 border-b bg-white lg:py-2.5'>
        <div className='px-6 flex items-center justify-between space-x-4'>
          ...
          <div className='flex space-x-2'>
            ...
            <button className='flex items-center justify-center h-10 p-2 rounded-xl border bg-gray-100 focus:bg-gray-100 active:bg-gray-200'>
              {totalItems > 0 && (
                <span className='text-sm mr-2 font-bold text-blue-800'>{totalItems}</span>
              )}
